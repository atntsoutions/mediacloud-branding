...
export class ParamService {
    ...
    Save(Record: any) {
      return this.http2.post<any>(this.gs.baseUrl + '/api/Master/Param/Save', Record, this.gs.headerparam2('authorized-fileupload'));
    }
    ...
    Lov(SearchData : any) {
      return this.http2.post<any>(this.gs.baseUrl + '/api/Admin/Lov/Lov', SearchData, this.gs.headerparam2('authorized'));
    }
