...
export class CompanyService {
    ...
    Save(Record: any) {
      return this.http2.post<any>(this.gs.baseUrl + '/api/Admin/Company/Save', Record, this.gs.headerparam2('authorized-fileupload'));
    }

    Delete(SearchData : any) {
      return this.http2.post<any>(this.gs.baseUrl + '/api/Admin/Company/Delete', SearchData, this.gs.headerparam2('authorized'));
    }
